        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p class="mt-1 text-slate-600">Share your thoughts and insights with the world</p>
                </div>
                    ...
                    <div class="p-6 md:p-8 space-y-8">
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex justify-end">
                                <span class="text-xs text-slate-400"><span id="title-count">0</span>/255</span>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex justify-end">
                                <span class="text-xs text-slate-400"><span id="excerpt-count">0</span>/500</span>
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="border-t border-slate-100 pt-4">
                                    ...
                                    <input type="datetime-local" name="published_at" id="published_at"
                                        value="{{ old('published_at') }}" min="{{ now()->format('Y-m-d\TH:i') }}"
                                        class="block w-full rounded-lg border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                ...
                                <div class="pt-6 flex flex-col gap-3">
                                    ...
                                    @else
                                        <button type="submit" name="publish_now" value="1"
                                            class="w-full inline-flex justify-center items-center px-4 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-amber-500 hover:bg-amber-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 transition-colors">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
